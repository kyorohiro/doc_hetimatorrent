...
##### 距離を定義する
 次、もう少し具体的に、「知っていそうな人を紹介する」を、P2Pネットワーク上で実現する方法を考えてみましょう。
 P2Pネットワークには、InfoHashという20バイトのデータが渡されます。このInfoHashからもっとも、データを所持していそうな端末を紹介する必要があります。どのようにして判断すれば良いでしょうか?
 
 ひとつの方法として距離を定義する方法です。Info
 
もう一度、私たちが構築するDHTについて考えてみましょう。
 
 InfoHashを持っていそうな人を探すのは、ただ無作為に知り合いを
